...
export const Tabs: React.FC<{ currentScreen: string; setScreen: (screenName: string) => void }> = ({
  ...
  console.log('Full mobile menu:', JSON.stringify(mobileMenu, null, 2))
  return (
      ...
      {mobileMenu && mobileMenu.length > 0 ? (
        <>
          {mobileMenu.map((menuItem) => {
            return (
              <TouchableOpacity
                ...
                style={[styles.tab, currentScreen === menuItem.name && styles.activeTab]}
              >
                <TabIconWrapper
                ...
                <Text
                  style={
                    currentScreen === menuItem.name ? styles.activeTabText : styles.inactiveTabText
                  }
                >
                  {menuItem.title}
                </Text>
          ...
          <TouchableOpacity
            ...
            style={[styles.tab, currentScreen === ROUTES.CHAT && styles.activeTab]}
          >
            ...
            <Text
              style={currentScreen === ROUTES.CHAT ? styles.activeTabText : styles.inactiveTabText}
            >
              Чат
            </Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity
            ...
            style={[styles.tab, currentScreen === ROUTES.CALENDAR && styles.activeTab]}
          >
            <TabIconWrapper
            ...
            <Text
              style={
                currentScreen === ROUTES.CALENDAR ? styles.activeTabText : styles.inactiveTabText
              }
            >
              Календарь
            </Text>
        ...
        >
          <Text
            style={currentScreen === ROUTES.MAIN ? styles.activeTabText : styles.inactiveTabText}
          >
            Home
          </Text>
        </TouchableOpacity>
