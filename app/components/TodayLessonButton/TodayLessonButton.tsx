 ...
 //   console.log(allLessons)
    ...
    return (
        <TouchableOpacity
            ...
            <View style={{width: '100%', flex: 1, flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between'}}>
                ...
                <View style={{ alignItems: 'flex-end',}}>
                    <Text style={{fontSize: 13, marginLeft: 8, textDecorationStyle: 'solid', textDecorationColor: 'black', textDecorationLine: 'underline'}}>Перейти</Text>
                </View>
            </View>
        </TouchableOpacity>
    );
