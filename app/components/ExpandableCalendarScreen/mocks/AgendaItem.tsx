...
export const AgendaItem = (props: ItemProps) => {
  ...
  const directionCourses = useAppSelector(
    (state) => state?.seminarianTopics?.data?.directionCourses
  )
  ...
  const isLoadingRescheduleLesson = useAppSelector(
    (state) => state?.seminarianTopics?.isLoadingRescheduleLesson
  )
  ...
  return (
    <View style={styles.card}>
      <View style={styles.timeContainer}>
        ...
        {isSeminarian && (
          <TouchableOpacity style={{ padding: 6 }} onPress={handleEditPress}>
            <EditIcon />
          </TouchableOpacity>
        )}
      </View>
      ...
      {item.isOffline ? (
        ...
        >
          {loading ? (
            ...
            <Text style={styles.btnText}>{item.link_to_meeting ? 'Перейти' : 'Нет cсылки '}</Text>
          )}
        </TouchableOpacity>
      )}
              ...
              <View style={styles.container}>
                    ...
                    {offlineLesson && (
                      <>
                        ...
                        <View style={styles.manualInputRow}>
                          ...
                          <TouchableOpacity onPress={() => setChooseMaterial(!chooseMaterial)}>
                  ...
                  <>
                    ...
                    <View style={styles.manualInputRow}>
                      ...
                      <TouchableOpacity onPress={() => setIsManual(!isManual)}>
                        <Text style={styles.manualInputLabel}>Ввести название урока вручную</Text>
                      </TouchableOpacity>
                    </View>
                    <TextInput
                      style={styles.dropdownDisabled}
                ...
                >
                  ...
                  <Text style={styles.saveButtonText}>
                    {selectedAction ? 'Сохранить' : 'Отменить'}
                  </Text>
                </TouchableOpacity>
              </View>
            </TouchableWithoutFeedback>
