...
export const HomeworkComponent = ({id}: HomeworkComponentProps) => {
    ...
    const data = homeworkType === 'homework' ? homework : homeworkType === 'controlwork' ? controlwork : classwork;
    ...
    const renderItem: ListRenderItem<HomeWorkType> = ({item}) => {
        ...
        switch (homeworkType) {
            case 'homework':
                return <HomeworkItem
                    item={item}
                    isDenyAccess={isDenyAccess}
                />;
            case 'controlwork':
                return <ControlWorkItem
                    item={item}
                    isDenyAccess={isDenyAccess}
                />;
            case 'classwork':
        ...
        <View style={styles.card}>
            <View style={styles.header}>
                ...
                <View style={{alignItems: 'flex-end', marginVertical: 10}}>
                    <View><Text>{completionPercentage}% / 100%</Text></View>
                    <View><Text>Кол-во попыток: {item.attempt}</Text></View>
                </View>
            </View>
            ...
            <View style={styles.row}>
                <View style={styles.infoContainer}>
                    ...
                    <View style={styles.valueBlock}>
                        <Text style={styles.value}>{item.lesson?.topic?.name}</Text>
                    </View>
                </View>
            </View>
            ...
            {
                item?.created_at && <View style={[GlobalStyle.mark, {
            ...
            {
                item?.mark && <View style={GlobalStyle.mark}>
